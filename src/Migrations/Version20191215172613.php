 ...
 */
final class Version20191215172613 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE orla_provisional_grupos_carrera (id INT AUTO_INCREMENT NOT NULL, grupo_carrera_id INT NOT NULL, image_name VARCHAR(255) DEFAULT NULL, update_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_9A40A4BCC69AF2D4 (grupo_carrera_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
