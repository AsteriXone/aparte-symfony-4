 ...
 */
final class Version20191210082233 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE proceso_orla_grupo (id INT AUTO_INCREMENT NOT NULL, grupo_carrera_id INT NOT NULL, estado VARCHAR(20) NOT NULL, UNIQUE INDEX UNIQ_A71B7BE4C69AF2D4 (grupo_carrera_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE proceso_orla_grupo ADD CONSTRAINT FK_A71B7BE4C69AF2D4 FOREIGN KEY (grupo_carrera_id) REFERENCES grupo_carrera (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE proceso_orla_grupo');
        $this->addSql('ALTER TABLE citas_fecha_cuadrante_grupo_carrera CHANGE usuario_id usuario_id INT DEFAULT NULL');
