 ...
 */
final class Version20190924073513 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image_gallery DROP image_size, CHANGE image_name image_name VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image_gallery ADD image_size INT NOT NULL, CHANGE image_name image_name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
