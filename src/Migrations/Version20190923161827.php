 ...
 */
final class Version20190923161827 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE galeria (id INT AUTO_INCREMENT NOT NULL, nombre_galeria VARCHAR(100) NOT NULL, carpeta VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
