 ...
 */
final class Version20200122082325 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE incidencias_carrera ADD orla_provisional_carrera_id INT DEFAULT NULL, CHANGE incidencia incidencia VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE incidencias_carrera DROP orla_provisional_carrera_id, CHANGE incidencia incidencia VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
