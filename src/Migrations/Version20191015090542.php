 ...
 */
final class Version20191015090542 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE muestras_carrera_grupo_carrera ADD votos INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE muestras_carrera_grupo_carrera DROP votos');
