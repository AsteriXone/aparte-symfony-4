 ...
 */
final class Version20190924072258 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image_gallery ADD galeria_id INT NOT NULL');
        $this->addSql('ALTER TABLE image_gallery ADD CONSTRAINT FK_D23B2FE6D31019C FOREIGN KEY (galeria_id) REFERENCES galeria (id)');
        $this->addSql('CREATE INDEX IDX_D23B2FE6D31019C ON image_gallery (galeria_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image_gallery DROP FOREIGN KEY FK_D23B2FE6D31019C');
        $this->addSql('DROP INDEX IDX_D23B2FE6D31019C ON image_gallery');
        $this->addSql('ALTER TABLE image_gallery DROP galeria_id');
