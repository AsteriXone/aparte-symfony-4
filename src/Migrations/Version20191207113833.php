 ...
 */
final class Version20191207113833 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE resegnia CHANGE disegnio_opciones disegnio_opciones INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE profesor_grupo_carrera CHANGE votos votos INT DEFAULT NULL');
        $this->addSql('ALTER TABLE resegnia CHANGE disegnio_opciones disegnio_opciones VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
