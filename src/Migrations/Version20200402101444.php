 ...
 */
final class Version20200402101444 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE visualizacion_orla_grupo_carrera (id INT AUTO_INCREMENT NOT NULL, user_carrera_id INT NOT NULL, orla_provisional_grupo_carrera_id INT NOT NULL, fecha_visualizacion DATE DEFAULT NULL, INDEX IDX_B7B12AC7611672E3 (user_carrera_id), INDEX IDX_B7B12AC7A43353E7 (orla_provisional_grupo_carrera_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE visualizacion_orla_grupo_carrera ADD CONSTRAINT FK_B7B12AC7611672E3 FOREIGN KEY (user_carrera_id) REFERENCES user_carrera (id)');
        $this->addSql('ALTER TABLE visualizacion_orla_grupo_carrera ADD CONSTRAINT FK_B7B12AC7A43353E7 FOREIGN KEY (orla_provisional_grupo_carrera_id) REFERENCES orlas_provisional_grupo_carrera (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE visualizacion_orla_grupo_carrera');
        $this->addSql('ALTER TABLE citas_fecha_cuadrante_grupo_carrera CHANGE usuario_id usuario_id INT DEFAULT NULL');
