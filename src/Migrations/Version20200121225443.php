 ...
 */
final class Version20200121225443 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE incidencias_carrera (id INT AUTO_INCREMENT NOT NULL, user_carrera_id INT NOT NULL, incidencia VARCHAR(255) DEFAULT NULL, descripcion LONGTEXT NOT NULL, INDEX IDX_3C67F991611672E3 (user_carrera_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE incidencias_carrera ADD CONSTRAINT FK_3C67F991611672E3 FOREIGN KEY (user_carrera_id) REFERENCES user_carrera (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE incidencias_carrera');
        $this->addSql('ALTER TABLE citas_fecha_cuadrante_grupo_carrera CHANGE usuario_id usuario_id INT DEFAULT NULL');
