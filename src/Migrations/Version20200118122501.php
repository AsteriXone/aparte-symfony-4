 ...
 */
final class Version20200118122501 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE orlas_provisional_grupo_carrera (id INT AUTO_INCREMENT NOT NULL, grupo_carrera_id INT NOT NULL, image_name VARCHAR(255) DEFAULT NULL, update_at DATETIME DEFAULT NULL, INDEX IDX_48073D47C69AF2D4 (grupo_carrera_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE orlas_provisional_grupo_carrera ADD CONSTRAINT FK_48073D47C69AF2D4 FOREIGN KEY (grupo_carrera_id) REFERENCES grupo_carrera (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE orlas_provisional_grupo_carrera');
        $this->addSql('ALTER TABLE citas_fecha_cuadrante_grupo_carrera CHANGE usuario_id usuario_id INT DEFAULT NULL');
