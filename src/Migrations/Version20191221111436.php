 ...
 */
final class Version20191221111436 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_carrera ADD is_votar_citas_active TINYINT(1) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE orla_provisional_grupos_carrera CHANGE image_name image_name VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE muestras_carrera_grupo_carrera CHANGE votos votos INT DEFAULT NULL');
        $this->addSql('ALTER TABLE orla_provisional_grupos_carrera CHANGE image_name image_name VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE proceso_orla_grupo CHANGE fecha_entrega fecha_entrega DATETIME DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE user_carrera DROP is_votar_citas_active');
    }
}
