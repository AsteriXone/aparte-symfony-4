 ...
 */
final class Version20191016120353 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE productos_carrera_grupo_carrera ADD precio INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE muestras_carrera_grupo_carrera DROP precio, CHANGE votos votos INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE muestras_carrera_grupo_carrera ADD precio INT DEFAULT NULL, CHANGE votos votos INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE productos_carrera_grupo_carrera DROP precio');
