...
final class UserCarreraAdmin extends AbstractAdmin
{
    protected $baseRouteName = 'usuarios-carrera';
    protected $baseRoutePattern = 'usuarios-carrera';
    ...
    {
        parent::configure();
        $this->classnameLabel = "Usuarios Carrera";
    }
    ...
    protected function configureDatagridFilters(DatagridMapper $datagridMapper): void
    {
        $datagridMapper
            ...
            // ->add('roles')
            // ->add('password')
            ->add('grupo_carrera', null, ['label' => 'Grupo'], '', [ 'query_builder' => function (EntityRepository $er) {
                    $container = $this->getConfigurationPool()->getContainer();
