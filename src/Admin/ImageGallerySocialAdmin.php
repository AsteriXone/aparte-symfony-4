...
final class ImageGallerySocialAdmin extends AbstractAdmin
{
    protected $baseRouteName = 'Imágenes Galería Social';
    protected $baseRoutePattern = 'imagenes-galeria-social';
    ...
    public function createQuery($context = 'list')
    {
        ...
        $query->setParameter('param', 'Social');
        return $query;
    }
