...
class VideosGrupoCarrera
{
     ...
     *
     * @Vich\UploadableField(mapping="video_carrera", fileNameProperty="imageName")
     *
     * @var File
     */
    private $imageFile;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\GrupoCarrera", inversedBy="videosGrupoCarreras")
